 ...
 *
 * MUST stay byte-for-byte compatible with scripts/hash-password.mjs (which
 * hashes ADMIN_PASSWORD_HASH_DEV/PROD) and templates/auth/users/password.ts -
 * all three hash/verify the same kind of value.
 */
